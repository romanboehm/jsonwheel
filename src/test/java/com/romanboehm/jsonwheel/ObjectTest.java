...
class ObjectTest extends JsonWheelTestMatrix {
    ...
    List<Arguments> args() {
        return List.of(
                ...
                arguments(named("object single kv null", new Arg("{\"foo\": null}", new HashMap<>() {{put("foo", null);}}))),
                ...
                arguments(named("object multiple kv", new Arg("{\"foo\": \"bar\", \"baz\": \"qux\", \"blerg\": 0.5}", Map.of("foo", "bar", "baz", "qux", "blerg", 0.5d))))
        );
    }
}
